...
- (void)setNews:(News *)news {
  ...
  titleLabel.frame = CGRectMake(titleLabel.frame.origin.x, titleLabel.frame.origin.y, titleLabel.frame.size.width, [SavedCell heightForLabelWithString:titleLabel.text  andWidth:WidthOfTitle]);
